...
class LocationDistanceToUseCaseImplTest {
    ...
    fun `currentLocationDistanceTo should return correct distance`() {
        ...
        val locationDistanceCalculatorClient = mockk<LocationDistanceCalculatorClient>()
        every {
            locationDistanceCalculatorClient.currentLocationDistanceTo(
                any(), any(), any(),
            )
        } returns 15f
        val useCase = LocationDistanceCalculatorUseCaseImpl(locationDistanceCalculatorClient)
